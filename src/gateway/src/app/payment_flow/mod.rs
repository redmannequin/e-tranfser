...
pub const PAYMENT_CREATE_PAGE: &str = "/app/payment";
pub const PAYMENT_STATUS_PAGE: &str = "/app/payment/status";
pub const PAYMENT_STATUS_UPDATE_PAGE: &str = "/app/payment/status_update";
#[allow(unused)]
pub const PAYMENT_TL_CALLBACK_PAGE: &str = "/app/payment/tl_callback";
